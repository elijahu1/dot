...
alias handbrake='ghb'
alias binc='sudo brillo -A'
alias bdec='sudo brillo -U'
alias bright='sudo brillo'
alias visudo='EDITOR=nvim visudo'
alias w='wpg -s  ~/Images/wallpapers/backgrounds/ ; wait 1; timeout 0.5s xsettingsd -c ~/.config/xsettingsd/xsettingsd.conf : clear'
...
alias j='.~/.scripts/journal | date +"%R - %a, %B %d, %Y" | xclip -select clipboard; cd ~/Dropbox/writing/journal; nvim volume-8.md'
